            ...
            {data && <>
                ...
                {data.characters &&
                    <section>
                        <h3>Characters</h3>
                        <ul>
                            {data.characters && data.characters.items.map((item, i) =>
                                <li key={i}>
                                    <a href="#" onClick={(e) => onResultClick(e, 'character', item.resourceURI)} target="_blank" rel="noopener noreferrer">
                                        {item.name}
                                    </a>
                                </li>)
                            }
                    ...
                    <section>
                        ...
                        <ul>
                            {data.stories && data.stories.items.map((item, i) =>
                                <li key={i}>
                                    <a href="#" onClick={(e) => onResultClick(e, 'story', item.resourceURI)} target="_blank" rel="noopener noreferrer">
                                        {item.name}
                                    </a>
                                </li>)
                            }
